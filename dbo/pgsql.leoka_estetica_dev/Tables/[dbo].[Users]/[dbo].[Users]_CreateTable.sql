...
ADD COLUMN IF NOT EXISTS "IsVkAuth" BOOLEAN NOT NULL DEFAULT FALSE,
    ADD COLUMN IF NOT EXISTS "VkUserId" BIGINT NULL;

ALTER TABLE IF EXISTS dbo."Users"
    ADD IF NOT EXISTS "LastAutorization" TIMESTAMP NOT NULL DEFAULT NOW(),
    ADD IF NOT EXISTS "IsMarkDeactivate" BOOLEAN   NOT NULL DEFAULT FALSE,
    ADD IF NOT EXISTS "DateCreatedMark"  TIMESTAMP NOT NULL DEFAULT NOW(),
    ADD IF NOT EXISTS "SubscriptionStartDate" TIMESTAMP NULL,
    ADD IF NOT EXISTS "SubscriptionEndDate" TIMESTAMP NULL;